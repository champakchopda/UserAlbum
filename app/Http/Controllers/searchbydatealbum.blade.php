 @if(isset($album) && !is_null($album))
            ...
            <div class="col-md-12 col-sm-6" id="post_user_{{Auth::user()->id}}">
               <div class="post" id="delete_album_{{$value->id}}">
                  ...
                  <span onclick="album_delete('{{$value->id}}','{{Auth::user()->id}}')" class="glyphicon  btn btn-danger unlike">Delete</span>  
                  @endif            
               </div>
            </div>
            @endforeach
            ...
            <div class="col-md-12">
              <p class="text-primary">Data Not Found</p>
            </div>
            @endif
